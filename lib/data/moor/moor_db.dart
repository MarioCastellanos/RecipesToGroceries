...
class MoorRecipe extends Table {
  ...
  //auto generating unique ids for each recipe
...
// Creating RecipeDatabase for moor with the tables MoorRecipe, MoorIngredient
// and respective daos
...
// Dao to control recipe access to the RecipeDatabase
...
//Dao to control ingredient access to the MoorIngredientTable
// in the RecipeDatabase
...
/// Conversion Methods
// converting a MoorRecipeData to Recipe
...
// Converting Recipe into and insertable MoorRecipe object its respective table
// ensuring that each field is not null
...
// converting moorIngredient to ingredient object
...
// converting Ingredinet to insertable MoorIngredient
